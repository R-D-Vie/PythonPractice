...
for number in numbers:
  if number % 2 == 0:
    ...
    #coding sum with list iteration (loops)
    import random
...
warm = ["red", "orange", "yellow", "burgundy", "pink",
        "rose", "pumpkin", "marigold", "gold", "citron", "amber"]
cool = ["blue", "green", "purple", "cyan", "violet",
        "indigo", "azure", "teal", "mint", "lime", "emerald"]
neutral = ["black", "white", "gray", "grey", "brown", "beige"]

colors = ["red", "black", "pink", "beige",
          "dark green", "azure", "amber", "light yellow"]
warm_count = 0
cool_count = 0
neutral_count = 0
misc_count = 0
